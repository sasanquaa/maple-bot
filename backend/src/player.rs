...
impl Moving {
    ...
    #[inline]
    fn auto_mob_can_skip_current_destination(&self, state: &PlayerState) -> bool {
...
impl UseKey {
    ...
    fn from_action_pos(action: PlayerAction, pos: Option<Point>) -> Self {
        match action {
